...
$pretrained_model = "E:\AI\stable-diffusion-webui\models\Stable-diffusion\sd_xl_base_1.0.safetensors" # base model path | 底模路径
$vae = "E:\AI\stable-diffusion-webui\models\VAE\sdxl-vae-fp16-fix.safetensors"
$is_v2_model = 0 # SD2.0 model | SD2.0模型 2.0模型下 clip_skip 默认无效
$v_parameterization = 0 # parameterization | 参数化 v2 非512基础分辨率版本必须使用。
$train_data_dir = "D:\downloads\liandange_1.6.2_v12.1\train" # train dataset path | 训练数据集路径
